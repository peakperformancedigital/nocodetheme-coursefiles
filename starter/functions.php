...
if ( ! function_exists( 'nocodetheme_enqueue_scripts' ) ) :
    ...
    wp_register_script( 'inline-script-1', '', [], '0.0.258', false );
    ...
    wp_enqueue_script( 'nocodetheme-pgia', get_template_directory_uri() . '/pgia/lib/pgia.js', [], '0.0.258', true);
    ...
    wp_enqueue_style( 'nocodetheme-theme', get_template_directory_uri() . '/css/theme.css', [], '0.0.258', 'all');

    wp_deregister_style( 'nocodetheme-style' );
    wp_enqueue_style( 'nocodetheme-style', get_template_directory_uri() . '/css/style.css', [], '0.0.258', 'all');

    wp_deregister_style( 'nocodetheme-style-1' );
    wp_enqueue_style( 'nocodetheme-style-1', get_bloginfo('stylesheet_url'), [], '0.0.258', 'all');
